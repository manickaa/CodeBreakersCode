def getIntersectionNode(head1, head2):
    ...
    2. While the two runners do not point to the same node, do:
...
#                                  In worst case, each runner goes through both the lists fully(if the intersection is at the end and lengths are not the same)
